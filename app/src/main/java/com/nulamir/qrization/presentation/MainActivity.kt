...
class MainActivity : ComponentActivity() {
    ...
    private lateinit var swagListAdapter: SwagListAdapter
    private var swagItemContainer: FragmentContainerView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        swagItemContainer = findViewById(R.id.shop_item_container)
        setupRecyclerView()
